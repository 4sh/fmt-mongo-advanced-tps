...
// Le wildcard index semble tout désigné pour ce cas. Il évite la multiplication des index pour gérer tous les cas.
// Mieux, si d'autres propriétés sont ajoutées sur les types existants ou que de nouveaux types de produit sont ajoutés,
// avec leurs propriétés propres, alors l'index sera capable de les indexer automatiquement.
db.products.createIndex({type: 1, "properties.$**": 1})